...
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="header-main">
    <h6 class="page-navigation">Services <i class="bi bi-arrow-right"></i>WebSite Development <i class="bi bi-arrow-right"></i> Custom Website Development</h6>
      <div class="header-details row " data-aos="zoom-in" data-aos-delay="150">
        <h2 style="font-family: 'Bricolage Grotesque', sans-serif;">Custom Website Development</h2>

          <div class="header-details-ppc">
            <!-- <h3>Our Experts have Created Many Types of Web Site</h3> -->
            <p style="font-family: 'Roboto', sans-serif;">We specialised in design,Build, manage, marketing</p>
            <p style="font-family: 'Roboto', sans-serif;">Your business website.</p>
          </div>

      </div>
      <div class="header-image" data-aos="fade-left" data-aos-delay="200">
        <img src="assets/img/web.jpg" alt="web design,seo agency,seo services agencies,internet marketing,seo agency,online marketing,digital marketing company,digital marketing agency,marketing agency">
      </div>
      
      <a class="get-report" data-aos="fade-up" data-aos-delay="150" href="#contact">Get A Demo
      <i class="bi bi-arrow-right-circle"></i></a>
  </div>
  <!-- ======= About Section ======= -->
  <section id="about" class="about pb-0" style="padding-top:80px;">
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-12 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
              
          <div class="section-title mt-3">
              <h2 class="h-title">WebSite Design</h2>
              <p>Website Development</p>
            </div>
                  
            <ul>
              <li><i class="ri-check-double-line"></i>As a leading Website development company, we understand your website is your reflection of your business and customer point of contact. We specialised in design, build, manage, marketing & your business website.</li>
              <li><i class="ri-check-double-line"></i>Web design is more than just visual appeal. The way a site’s user interface “feels” to the user is also a critical factor. These tools will help make sure your own UI design is on point.</li>
              <li><i class="ri-check-double-line"></i>After a website is designed, it needs to be developed! Whether you’re working on both sides of the process (designing AND building a site), or building a site based on someone else’s designs, these developer tools will help you make that design a virtual reality.</li>
              <li><i class="ri-check-double-line"></i>Sometimes you’ll need to code every part of a website from scratch—but sometimes you won’t. Here’s a list of frameworks, templates, code packs, and themes you can use to cut down on heavy lifting.</li>
              <li><i class="ri-check-double-line"></i>You can’t start coding without learning basic skills, but once you have those skills nailed it’s time to learn how to code artfully. These guides will teach you best coding practices that will elevate your work beyond the basic level.</li>
          </ul>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Easy Navigation</a></h4>
              <p>We create creative & appropriate designs for your website, according to your requirement.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">Responsive Website</a></h4>
              <p>We create fully mobile friendly website, because our motto is that your site display on every device in easy way. </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Clean HTML Coding </a></h4>
              <p>Our team of expert developers always maintain a clean HTML, CSS, & JavaScript coding sturcture.. </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h4><a href="">Google Standard Coding</a></h4>
              <p>We make sure that your website coding is err-less and follows all the coding guidelines of Google.. </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box">
              ...
              <h4><a href="">UI (User Interface)</a></h4>
              <p>Web design is more than just visual appeal. The way a site’s user interface “feels” to the user is also a critical factor. These tools will help make sure your own UI design is on point. </p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box">
              ...
              <h4><a href="">Web Development Resources</a></h4>
              <p>After a website is designed, it needs to be developed! Whether you’re working on both sides of the process, or building a site based on someone else’s designs, these developer tools will help you make that design a virtual reality. </p>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- End Services Section -->
             ...
             <!-- ======= Contact Section ======= -->
             <section id="contact" class="contact mt-2 pb-0 mb-0">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
