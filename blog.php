...
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!-- End Header -->
      ...
      <div class="blog-main">
        <img src="./assets/img/blog-bg.jpg" class="img-fluid w-100">
</div>
        ...
        <div class="container">
            <div class="row" >
                <div class="col-lg-4" data-aos="fade-right">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px; ">
                      <img src="./assets/img/blog-1.avif" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">Web Development</a></p>
                            <h4>How To Choose The Best Web Development For Your Business</h4>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-4"  data-aos="flip-up">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                      <img src="./assets/img/blog-2.jpg" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">Digital Marketing</a></p>
                            <h4>How To Choose The Best Digital Marketing Agency</h4>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-4" data-aos="fade-left">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                      <img src="./assets/img/blog-3.jpg" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">SEO  Facts</a></p>
                            <h4>15 SEO Myths That Need to Be Debunked In 2023</h4>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-4 mt-5" data-aos="fade-right">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                      <img src="./assets/img/blog-4.jpg" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">Graphic Desing</a></p>
                            <h4>How To Choose The Best Graphic Desinging For Your Business</h4>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-4 mt-5" data-aos="flip-up">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                      <img src="./assets/img/blog-5.jpg" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">Bulk SMS</a></p>
                            <h4>How to Choose The Best Bulk SMS For Your Business</h4>
                        </div>
                    </div>
                  </div>
                  <div class="col-lg-4 mt-5" data-aos="fade-left">
                    <div class="card2" style="box-shadow: rgba(0, 0, 0, 0.15) 1.95px 1.95px 2.6px;">
                      <img src="./assets/img/blog-6.jpg" class="img-fluid">
                        <div class="card-body2 p-5">
                          <p class="text-primary"><a href="#">OOH Service</a></p>
                            <h4>How to Choose The Best OOH Adverstiment For Your Business</h4>
                        </div>
                    </div>
                  </div>
                </div>
