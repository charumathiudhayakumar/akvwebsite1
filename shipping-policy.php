  ...
  <!-- End Header -->
         ...
         <section class="pt-0 pb-0">
            <div class="header-main">
             <h6 class="page-navigation">Home <i class="bi bi-arrow-right"></i>Shipping Policy</h6>
             <div class="header-details row " data-aos="zoom-in" data-aos-delay="150">
           <div class="header-details-ppc">
              <h2 style="font-family: 'Bricolage Grotesque', sans-serif;" class="text-blue">Shipping Policy</h2>
              <!--  <p style="font-family: 'Roboto', sans-serif;">Offering a Complete Range of Web Solutions Including </p>
              <p style="font-family: 'Roboto', sans-serif;">WebSite Development, Digital Marketing, E-commerce solutions</p> -->
            </div>
           </div>
        <div class="header-image" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/img/shipping-policy.jpg" alt="Aboutus Image">
        </div>      
        
        <a class="get-report text-white" style="font-family: 'Lobster',sans-serif;"  data-aos="fade-up" data-aos-delay="150" href="#contact">Know more
        ...
        <!-- ======= About Section ======= -->
        <section id="about" class="about section_all">
            <div class="container" data-aos="fade-up">
      
              <div class="row">
                <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                  <img src="assets/img/shipping-policy.jpg" class="img-fluid mt-5" alt="">
                </div>
                <div class="col-lg-10 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
                    
                <div class="section-title mt-1">
                    <h2 class="h-title">AKV TECHNOLOGIES</h2>
                    <p>Shipping Policy</p>
                  </div>
                        
                  <ul>
                    <p>Last updated: January 10, 2023</p>
          <p>A shipping policy is typically associated with physical products and the delivery process. However, for a digital marketing agency that primarily provides services rather than physical products, you would have a "Service Agreement" or "Terms of Service" instead of a shipping policy. These documents outline the terms and conditions under which your agency offers its services to clients. Here's a general structure for such a policy:</p>
          AKV Technologies Service Agreement
          <h2 class="h-title text-blue" >Introduction</h2>
          
          <p>This Service Agreement ("Agreement") is entered into by and between AKV Technologies ("Company") and the client ("Client"). By engaging in our services, the Client agrees to the terms and conditions outlined in this Agreement.</p>
          <h2 class="h-title text-blue">Services Offered</h2>
          <p class="">Describe the digital marketing services your agency provides. This section should outline the specific services, such as SEO, social media management, content creation, PPC advertising, etc., that your agency offers to clients.</p>
          <h2 class="h-title text-muted">Payment Terms</h2>
          <p>Detail the payment terms, including pricing, billing cycles, accepted payment methods, and any late payment fees or penalties. Be clear about when and how payments should be made.</p>
          <h2 class="h-title text-blu"> Scope of Work</h2>
          <p>Usage Data is collected automatically when using the Service.</p>
          <p>Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser type, browser version, the pages of our Service that You visit, the time and date of Your visit, the time spent on those pages, unique device identifiers and other diagnostic dataDefine the scope of work for each service you offer. Specify the deliverables, timelines, and any client responsibilities. This helps manage expectations and avoid scope creep.</p>
          <h2 class="h-title text-blue"> Client Responsibilities</h2>
          <p>List the responsibilities of the client, including providing necessary information, access to accounts, and timely feedback, to ensure the successful execution of services.</p>
         
          <h2 class="h-title text-blue">Intellectual Property</h2>
          <p>Explain who owns the intellectual property created during the engagement (e.g., content, graphics). Typically, the client owns the final output, but rights to templates, tools, or processes used may differ.</p>
          <h2 class="h-title text-blue">Confidentiality</h2>
          <p>Discuss the handling of confidential information, including client data and business strategies. Assure the client of data security and confidentiality.</p>
          <h2 class="h-title text-blue">Termination</h2>
          <p>The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes, and enforce our legal agreements and policies.</p>
          <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of Our Service, or We are legally obligated to retain this data for longer time periods.Outline the conditions under which either party can terminate the agreement. Specify notice periods and any refund policies if applicable.</p>
          <h2 class="h-title text-blue">Dispute Resolution</h2>
          <p>Detail the process for resolving disputes, whether through mediation, arbitration, or litigation.</p>
          <h2 class="h-title text-blue">Amendments</h2>
          <p>State that the agreement can only be amended in writing and signed by both parties.</p>
          <h2>Governing Law</h2>
          <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
          <h3 class="h-title text-blue">Other legal requirements</h3>
          <p>Specify the governing law and jurisdiction under which any legal matters will be resolved.</p>
         
          <h2 class="h-title text-blue"> Limitation of Liability</h2>
          <p>Define the limits of liability in case of errors, omissions, or any other issues related to the services provided.</p>
         
          <h2 class="h-title text-blue">Warranty</h2>
          <p>Explain any warranties or guarantees you offer regarding the quality of your services.</p>
          <h2 class="h-title text-blue"> Force Majeure</h2>
          <p>Describe how the agreement handles unforeseeable events that may affect the performance of services.</p>
          <h2 class="h-title text-blue">Contact Us</h2>
          <p>If you have any questions about this Shipping  Policy, You can contact us:</p>
          <ul>
              <li>By email: info@akvtechnologies.com</li>
              <li>Call Us: +91 96208 26156 </li>
          </ul>
          <!-- <ul>
          <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cba2a5ada48baaa0bdbfaea8a3a5a4a7a4aca2aeb8e5a8a4a6">[email&#160;protected]</a></li>
            ...
            <!-- ======= About Section End ======= -->
             ...
             <!-- ======= Contact Section ======= -->
      <section id="contact" class="contact section_all">
        <div class="container" data-aos="fade-up">
