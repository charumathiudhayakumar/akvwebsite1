...
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!-- Header Main Section -->
       <section class="pb-0"style="padding-top:80px;">
  <div class="header-main">
    <h6 class="page-navigation">Home <i class="bi bi-arrow-right"></i> Contact Us</h6>

      <div class="header-details" data-aos="fade-right" data-aos-delay="150">
          <h1 class="digital-heading-text">Contact Us</h1>
          <p>Feel free to write</p>
      </div>

      <img src="assets/img/contact_us.png" data-aos="fade-left" alt="digital marketing agency image digital marketing company online marketing">

      <a class="get-report get-started-btn" data-aos="fade-right" data-aos-delay="150" href="#contact">Get Proposal <i class="bi bi-arrow-right-circle"></i></a>
  </div>
</section>
  <!-- ======= About Section ======= -->
      ...
      <div class="container" data-aos="fade-left" data-aos-delay="100">
        <div class="row">
          ...
          <div class="section-title mt-3">
              <h2 class="h-title">AKV Technologies</h1>
              <p>Get in touch with us</p>
            </div>
                  
            <ul data-aos="fade-left" data-aos-delay="200">
              <li>If you think we might be a good fit for a project you’re working on and you’d like to get the feel of how we can work together please contact us using contact data below and we’ll get back to you as soon as possible.</li>
          </ul>
          </div>
        </div>
      </div>
  ...
  <section class="pt-0">
      ...
      <div class="row">
        <div class="col-md-12">
          <iframe src="https://maps.google.com/maps?q=4th+Floor,+Classic+Arena,+1597/2662,+AECS+Layout,+A+Block,+Singasandra,+Bengaluru,+Bangalore,+Karnataka,+India,+560068&output=embed" width="100%" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>
        </div>
      </div>
    </div>
  </section>
    ...
    <div class="section-title">
      ...
      <div class="row pt-5">
        ...
        <div class="info">
          <div class="address">
            ...
            <h4>Location:</h4>
            <h4>INDIA</h4>
            <p>4th Floor, Classic Arena, 1597/2662, AECS Layout, A Block, Singasandra, Bengaluru,Karnataka, India, 560068</p> <br>
            <h4>USA</h4>
      ...
      <div class="col-lg-7 mt-5 mt-lg-0">
        ...
        <form action="" method="post" role="form" class="php-email-form">
          ...
          <div class="row">
            <div class="col-md-6 form-group mt-3 mt-md-0">
              <input type="phone" class="form-control" name="phone" id="phone" placeholder="Mobile Number" required>
            </div>
            <div class="col-md-6 form-group mt-3 mt-md-0">
          ...
          <div class="text-center"><button type="submit" name="get_proposal">Get A Free Proposal <i class="bi bi-arrow-right-circle"></i></button></div>
        </form>
      </div>
    </div>
  </div>
