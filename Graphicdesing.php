...
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="header-main">
    <h6 class="page-navigation">Services <i class="bi bi-arrow-right"></i>Graphic Design</h6>
      <div class="header-details row " data-aos="zoom-in" data-aos-delay="150">
        <h1 class="e-commerce-font" style="font-family: 'Bricolage Grotesque', sans-serif;">Graphic Desinger</h1>

          <div class="header-details-ppc">
              <p style="font-family: 'Roboto', sans-serif;"><i class="ri-check-double-line"></i> At AKV Technologies , we believe that the visual elements of a website are its soul. Our commitment to excellence in graphic design is at the core of what we do. We understand that a visually appealing website not only captures attention but also creates lasting impressions.<br><br/>
            <i class="ri-check-double-line"></i>We've had the privilege of working with diverse clients across industries, transforming their online presence into visually stunning and highly effective platforms.
            </p>
          </div>

      </div>
      <div class="header-image" data-aos="fade-left" data-aos-delay="200">
        <img src="assets/img/graphic.jpg" alt="e-commerce website design image">
      </div>
      
      <a class="get-report text-white" data-aos="fade-up" data-aos-delay="150" href="contactUs.php" target="_blank">Know More
      <i class="bi bi-arrow-right-circle"></i></a>
  </div>

  <!-- ======= About Section ======= -->
  
  <section id="contact" class="contact section_all pb-0 mt-5"style="padding-top:80px;">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
            <h2 class="h-title">Our Project</h2>
            
          </div>
     <div class="container mt-5">
    <div class="row"> 
  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
    <img src="assets/img/gg-1.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/g-2.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/gg-6.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/logo.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/gg-8.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/gg-2.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/gg-16.png"  class="img-fluid" data-aos="fade-right" id="fluid">
    <img src="assets/img/gg-11.png"  class="img-fluid" data-aos="fade-right" id="fluid">
  </div>
  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
    <img src="assets/img/gg-15.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/gg-7.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/gg-7.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/gg-3.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/gg-13.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/g-1.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
    <img src="assets/img/g-3.png"  class="img-fluid" data-aos="zoom-in" id="fluid">
  </div>  
  <div class="col-lg-4 col-md-3 col-sm-6 col-xs-6">
    <img src="assets/img/gg-17.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/gg-5.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/gg-9.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/gg-10.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/g-4.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/gg-12.png"  class="img-fluid" data-aos="fade-left" id="fluid">
    <img src="assets/img/gg-14.png"  class="img-fluid" data-aos="fade-left" id="fluid">
  </div>
</div>
</div>
</div>
 ...
 <!-- ======= Services Section ======= -->
  ...
  <!-- End Services Section -->
         ...
         <!-- ======= Contact Section ======= -->
         <section id="contact" class="contact section_all pb-0 mt-5">
        <div class="container" data-aos="fade-up">
          <div class="section-title">
