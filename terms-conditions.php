  ...
  <!-- End Header -->
         ...
         <section class="pt-0 pb-0">
            <div class="header-main">
             <h6 class="page-navigation">Home <i class="bi bi-arrow-right"></i>Terms & Conditions</h6>
             <div class="header-details row " data-aos="zoom-in" data-aos-delay="150">
           <div class="header-details-ppc">
              <h2 style="font-family: 'Bricolage Grotesque', sans-serif;" class="text-blue">Terms & Conditions</h2>
        ...
        <div class="header-image" data-aos="fade-left" data-aos-delay="200">
          <img src="assets/img/terms-conditions.jpg" alt="Aboutus Image">
        </div>      
        ...
        <section id="about" class="about section_all">
            <div class="container" data-aos="fade-up">
              ...
              <div class="row">
                <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                  <img src="assets/img/terms-conditions.jpg" class="img-fluid mt-5" alt="">
                </div>
          ...
          <h2 class="h-title text-blue" >Acceptance of Terms</h2>
         <p>By engaging AKV Technologies for digital marketing services, you agree to abide by these Terms and Conditions ("Agreement"). This Agreement constitutes a legally binding contract between AKV Technologies ("Company") and the client ("Client").</p>
          <h2 class="h-title text-blue">Services

</h2>
          <p class="h-title text-blue">AKV Technologies will provide digital marketing services as outlined in the Service Agreement, which will include specific deliverables, timelines, and pricing.</p>
          
          <h2 class="h-title text-blue">Payment</h2>
          <p>While using Our Service, We may ask You to provide Us with certain personally identifiable information <ul>
          <li>
          <p>The Client agrees to pay AKV Technologies for the services provided, as per the terms specified in the Service Agreement.</p>
          </li>
          <li>
          <p>Invoices are payable within [Specify Payment Terms] from the date of receipt.</p>
          </li>
          </ul>
          <h2 class="h-title text-blue">Confidentiality</h2>
          <p>Both parties agree to maintain the confidentiality of any proprietary or confidential information shared during the course of the engagement.</p>
          <h2 class="h-title text-blue"> Intellectual Property</h2>
          <p>The Client acknowledges that all intellectual property developed during the engagement, including but not limited to content, graphics, and software, remains the property of AKV Technologies unless otherwise specified in the Service Agreement.</p>
          <h2 class="h-title text-blue">Termination</h2>
          <p>1. Either party may terminate the engagement with written notice, as specified in the Service Agreement.</p>
          <p>2.In case of early termination, AKV Technologies may bill the Client for services rendered up to the termination date.</p>
          <h2 class="h-title text-blue">Limitation of Liability</h2>
          <p>AKV Technologies is not liable for any damages or losses incurred by the Client, including but not limited to lost profits, business interruption, or data loss.</p>
         
          <h2 class="h-title text-blue">Indemnification</h2>
          <p>The Client agrees to indemnify and hold AKV Technologies harmless from any claims, liabilities, costs, or expenses arising from the Client's use of the services.</p>
          
          <h2 class="h-title text-blue">Force Majeure</h2>
          <p>AKV Technologies is not liable for any failure to perform its obligations under this Agreement due to circumstances beyond its control.</p>
            <h2 class="h-title text-blue">Governing Law and Jurisdiction</h2>
          <p>1.This Agreement shall be governed by and construed in accordance with the laws of [Specify Jurisdiction].</p>
          <p>Any disputes arising from this Agreement will be subject to the exclusive jurisdiction of the courts in [Specify Jurisdiction].</p>
          <h2 class="h-title text-blue">Amendments</h2>
          <p>AKV Technologies reserves the right to amend these Terms and Conditions at any time. Clients will be notified of any changes, and the revised terms will be posted on AKV Technologies’s website.</p>

          <h2 class="h-title text-blue">Entire Agreement</h2>
          <p>This Agreement represents the entire understanding between the parties and supersedes all prior agreements or understandings, whether written or oral.</p>
