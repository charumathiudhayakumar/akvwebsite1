...
<div class="modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="header-main">
    <h6 class="page-navigation">Services <i class="bi bi-arrow-right"></i>WebSite Development <i class="bi bi-arrow-right"></i> E-Commerce Website</h6>
      <div class="header-details row " data-aos="zoom-in" data-aos-delay="150">
        <h1 class="e-commerce-font" style="font-family: 'Bricolage Grotesque', sans-serif;">E-Commerce Website Development</h1>

          <div class="header-details-ppc">
              <p style="font-family: 'Roboto', sans-serif;"><i class="ri-check-double-line"></i> Multiple currencies, languages and payment gateways support <br>
            <i class="ri-check-double-line"></i> Personalize your mobile E-commerce website as per your preference <br>
            <i class="ri-check-double-line"></i> Loaded with 100+ E-commerce friendly features <br>
            <i class="ri-check-double-line"></i> Enjoy the advantage of a native app on Android, iOS and Windows</p>
          </div>

      </div>
      <div class="header-image" data-aos="fade-left" data-aos-delay="200">
        <img src="assets/img/e-commrece-page.jpg" alt="e-commerce website design image">
      </div>
      
      <a class="get-report text-white" data-aos="fade-up" data-aos-delay="150" href="https://rupexim.in/" target="_blank">View Demo
      ...
      <div class="container" data-aos="fade-up">
        <div class="row">
          <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/responsive.png" class="img-fluid mt-5 about-img" alt="responsive website design image">
          </div>
          
          <div class="col-lg-8 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
              
          <div class="section-title mt-3">
              <h2 class="h-title">WebSite Developement</h2>
              <p>What We Develope</p>
            </div>
                  
            <ul>
              <li><i class="fas fa-location-arrow"></i><b> Easy Navigation : </b> <br>
              We create creative & appropriate designs for your website, according to your requirement.
            </li>
              <li><i class="bi bi-code-slash"></i><b>Clean HTML Coding : </b><br>
              Our team of expert developers always maintain a clean HTML, CSS, & JavaScript coding sturcture.
            </li> 
              <li><i class="fas fa-mobile-alt"></i><b> Responsive Website : </b><br>
              We create fully mobile friendly website, because our motto is that your site display on every device in easy way.
            </li>
              <li><i class="bi bi-google"></i><b>Google Standard Coding : </b><br>
              We make sure that your website coding is err-less and follows all the coding guidelines of Google.
            </li>
          </ul>
          </div>
        </div>
  ...
  <section id="about" class="about pb-0" >
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
          <img src="assets/img/vendors.jpg" class="img-fluid mt-5 about-img" alt="e-commerce website for vendors image">
        </div>

        <div class="col-lg-8 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
            
        <div class="section-title mt-3">
            <h2 class="h-title">Multi Vendor E-Commerce</h2>
            <p>The Best Ecommerce Platforms & Shopping Carts for Multi-vendor Ecommerce Website</p>
          </div>
                
          <ul>
            <li><i class="ri-check-double-line"></i>
            For a fully-customized, secure, and search engine friendly multi-vendor e-commerce platform, born out of our decade long 
            Multi-vendor online shops, but you can find popular niche multi-vendor sites.
          </li>
          <li><i class="ri-check-double-line"></i>
  ...
  <section id="about" class="about pb-0">
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
          <img src="assets/img/tamplate-ecommerce.png" class="img-fluid mt-5 about-img" alt="website design services">
        </div>
        
        <div class="col-lg-8 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
            
        <div class="section-title mt-3">
            <h2 class="h-title">Unique User Experience</h2>
            <p>We create Unique User Experience website, with various featutes</p>
          </div>
  ...
  <section id="about" class="about pb-0"style="padding-top:80px;">>
    <div class="container" data-aos="fade-up">
      <div class="row">
        ...
        <div class="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
          <img src="assets/img/mobile-ecommerce.png" class="img-fluid mt-3 about-img" alt="mobile responsive website design">
        </div>

        <div class="col-lg-8 pt-5 pt-lg-0 order-2 order-lg-1 content text-left" data-aos="fade-right" data-aos-delay="100">
            
        <div class="section-title mt-3">
            <h2 class="h-title">Mobile Based E-Commerce</h2>
            <p>An Exclusive mobile shopping app for your E-commerce store</p>
          </div>
          ...
          <ul>
            ...
            <li><i class="ri-check-double-line"></i>
            Personalize your mobile E-commerce website as per your preference
          </li>
            <li><i class="ri-check-double-line"></i>
            Loaded with 100+ E-commerce friendly features
          </li>
            <li><i class="ri-check-double-line"></i>
